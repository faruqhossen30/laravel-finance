...
@section('content')
    ...
    <section class="mx-auto bg-white border rounded-md dark:bg-gray-800 dark:text-slate-400 dark:border-gray-500">
        <div class="flex items-center justify-between p-6 py-8 pl-4 border-gray-200 dark:border-gray-500">
            <div class="flex items-end">
                <h2 class="text-3xl font-semibold dark:text-gray-200 text-gray-400">Website Settings</h2>
                {{-- <span class="px-2 text-gray-400">1.0</span> --}}
            </div>
            <button type="button">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-10 h-10 text-gray-500  dark:text-gray-200">
        ...
        {{-- sidebar start --}}
        <div class="grid grid-cols-6 w-full border border-gray-200 dark:border-gray-500">
            <div class="col-span-1 border-gray-200 dark:border-gray-500 border-r ">
                {{-- sidebar start --}}
            ...
            <div class="col-span-5 border-b dark:border-gray-500">
                <h3 class="px-4 py-3 dark:border-gray-500 border-b dark:text-gray-200 bg-gray-50 dark:bg-gray-900">
                    {{ $title ?? 'Setting' }}</h3>
                {{ $slot }}
            </div>
        </div>
