...
@section('breadcrumb')
    <x-breadcrumb pageone="Client" pageoneRoute="{{ route('client.index') }}" pagetwo="Edit" />
@endsection
@section('content')
                    ...
                    <form action="{{ route('client.update', $client->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-12 gap-5 ">
                            <div class="col-span-12 lg:col-span-8 bg-white dark:bg-gray-800 p-4 rounded-lg">
                                <x-form.input label="Client Title" name="title" value="{{ $client->title }}" />
                            ...
                            <div class="col-span-12 lg:col-span-4 bg-white dark:bg-gray-800 p-4 rounded-lg">
                                <div class="col-span-3 pt-1 space-y-2">
                                    ...
                                    <input name="thumbnail" class="dropify" type="file" id="myDropify"
                                        data-default-file="{{ asset('storage/' . $client->thumbnail) }}">
                                </div>
                            </div>
                        </div>
