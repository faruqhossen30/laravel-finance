...
<footer class="mt-auto w-full max-w-[85rem] border-t mt-3 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <!-- Grid -->
    <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
      <div>
        {{-- <a class="flex-none text-xl font-semibold text-black focus:outline-none dark:text-white" href="#" aria-label="Brand">Brand</a> --}}
        <img src="{{asset('uploads/logo/'.$site->logo)}}" class="h-8 w-32 " alt="Flowbite Logo" />
      </div>
      <!-- End Col -->
