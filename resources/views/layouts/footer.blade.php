...
<footer
    class='md:hidden grid grid-cols-5 border-t border-gray-200 dark:border-gray-600 text-sm text-gray-800    bg-white dark:bg-gray-700 inset-x-0 bottom-0 fixed pt-2'>
    ...
    <div class="hs-dropdown relative inline-flex">
        ...
        <button id="hs-dropdown-with-icons" type="button"
            class="hs-dropdown-toggle pl-2 inline-flex justify-center items-center  align-middle  transition-all col-span-1 flex-col">
            <UserCircleIcon class="h-5 hover:bg-gray-200 hover:dark:bg-gray-50 text-gray-500 dark:text-gray-400" />
            <span>Account</span>
        </button>

        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden bg-white shadow-md rounded-lg p-2 mt-2 divide-y divide-gray-200 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700"
...
<section class="w-full border-t dark:border-t-gray-700 bg-gray-100 dark:bg-slate-900">
    <footer class="hidden container lg:block  px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="grid grid-cols-12 py-12">
            <div class="col-span-5">
                <div class=" space-y-6">
                    ...
                    <p class="text-sm text-gray-800 leading-7 font-light dark:text-gray-400 capitalize">
                        We provide expert insights, simple comparisons, <br> and   calculators for personal loans, mortgages, <br>
                         and   credit card rates.

                        Make smarter financial  <br>decisions and plan for a secure future with ease.
                    </p>

                    <div class="flex space-x-2 items-center">
                        <a href="https://x.com/boostcareit" target="_blank">
                            <svg class="w-5 h-5 text-gray-800  dark:text-gray-400 capitalize " aria-hidden="true"
                        ...
                        <a href="https://www.linkedin.com/company/boostcareit" target="_blank">
                            <svg class="w-6 h-6 text-gray-800  dark:text-gray-400 capitalize " aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                viewBox="0 0 24 24">
            ...
            <div class="col-span-4 pl-10">
                <h6 class='text-gray-800   font-bold dark:text-gray-400  capitalize  pb-5'>About us
                </h6>
                <p><a href="#" class='text-gray-800  dark:text-gray-400  capitalize  text-sm'>Sitemap</a></p>
                <p><a href="#" class='text-gray-800   dark:text-gray-400 capitalize  text-sm'>Contact us

                    </a></p>
                <p><a href="#" class='text-gray-800  dark:text-gray-400  capitalize  text-sm'>Personal Loan
                    </a></p>

                <p><a href="#" class='text-gray-800  dark:text-gray-400  capitalize  text-sm'>Compare rates
                    </a></p>
                <p><a href="#" class='text-gray-800  dark:text-gray-400  capitalize  text-sm'>Latest news
                    </a></p>

            </div>
            <div class="col-span-3">
                <h6 class='text-gray-800   font-bold dark:text-gray-400 capitalize  pb-5'>Legal</h6>
    ...
    <div class=" mt-1 dark:bg-slate-800 bg-gray-200">
        <div class="py-3 flex justify-center">
            <p class='text-center text-base font-bold text-gray-800 dark:text-gray-400'> Bankingscoop 2024 | All right
                reserved.</p>
        </div>
