            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-4 sm:col-span-12 sm:p-5">
                    <div class="bg-gray-100 px-5 border border-gray-400">
                        ...
                        <!-- Loan Amount -->
                        <div class="mb-5">
                            <label for="loan_amount" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Loan Amount
                            </label>
                ...
                <div class="col-span-8 p-5 w-full">
                        ...
                        <div class="flex justify-between px-4">
                            ...
                            <div class="flex px-5">
                                <div class="mx-8">
                                    ...
                                    <h1 class="text-3xl font-bold"><sup>$</sup>{{ number_format($monthlyPayment ?? 0, 2) }}</h1>
                                </div>
                                <div>
                                    <p class="text-xl">Loan Term (Years)</p>
                                    <h1 class="text-3xl font-bold">{{ $loanTermYears ?? 0 }}</h1>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="schedule" class="px-6 my-3 border border-gray-400  hidden">
                        ...
                        <div class="py-3 flex justify-between">
                            <div class="space-y-3">
                                <p>Start Date</p>
                                <input type="date" name="start_date" value="{{ old('start_date', date('Y-m-d')) }}" id="start_date"
                                    class="rounded-lg w-[250px]">
                            </div>
                            <div>
                            ...
                            <div class="-m-1.5 overflow-x-auto">
                                <div class="p-1.5 min-w-full inline-block align-middle">
                                    <div class="overflow-hidden">
                                        ...
                                        <!-- Print Schedule Link -->
                                        <a href="#" class="py-3 flex justify-end underline text-blue-600">Print Schedule</a>
                                    </div>
                                </div>
                            </div>
                        </div>
