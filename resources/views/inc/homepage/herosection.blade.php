...
<section class="relative  bg-gray-100  pb-10 lg:pb-20 min-h-screen " >
    ...
    <div class="relative container pt-12 px-4 mb-20 mx-auto space-y-3 text-center">

      <h2 class=" lg:mb-5 sm:text-5xl md:text-[54px] lg:py-0 capitalize text-slate-800 text-3xl lg:text-[44px] xl:text-5xl 2xl:text-6xl font-bold ">Take care of your performance every day.</h2>
      <p class="max-w-3xl  py-6 mx-auto mb-8 lg:py-1 text-justify sm:text-center lg:mb-10 text-slate-800 text-xl opacity-50">Build a well-presented brand that everyone will love. Take care to develop resources continually and integrity them with previous projects.</p>
    </div>
